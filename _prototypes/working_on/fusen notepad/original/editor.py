...
class Editor(QsciScintilla):
    def __init__(self, parent=None):
        ...
        # caret
        self.setCaretForegroundColor(qtg.QColor("#ffb454")) # this is the color of the blinking cursor
        self.setCaretLineVisible(True)
        self.setCaretWidth(2)
        self.setCaretLineBackgroundColor(qtg.QColor("#dedcdc")) # this is the color of the text highlight
